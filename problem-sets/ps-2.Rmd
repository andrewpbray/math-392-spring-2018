...
Explore the convergence properties of the $\chi^2$ statistics to the $\chi^2$ distribution when we model an individual cell count as Poisson. This exploration can take the form of analysis and/or simulation approaches.
